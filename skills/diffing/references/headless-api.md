...
| AI evidence | `ai_evidence_list`, `ai_evidence_map`, `ai_evidence_read`, `ai_evidence_search`, `ai_evidence_symbols`, `ai_evidence_verify`, `ai_evidence_history`, `ai_evidence_discussion` | `evidence list/map/read/search/symbols/verify/history/discussion`; read-only navigation of a retained capture |
