...
| AI evidence | `ai_evidence_list`, `ai_evidence_map`, `ai_evidence_read`, `ai_evidence_search`, `ai_evidence_symbols`, `ai_evidence_verify` | HTTP `/api/ai/evidence*`; read-only navigation of a retained capture, no CLI mirror |
