...
function SeveritySelect({
  ...
  const current =
    SEVERITY_OPTIONS.find((o) => o.value === value) ?? SEVERITY_OPTIONS[0]!;
  return (
    <BaseSelect.Root
      value={value}
...
export function CommentForm({
  ...
  return (
    <div
      className="comment-form comment-form-sheet"
      role="form"
    ...
    >
      {rangeEditable && range ? (
        <div className="comment-form-range" aria-live="polite">
          ...
          <div
            className="comment-form-range-controls"
            role="group"
            aria-label="Comment line range"
          >
            <div className="comment-form-range-edge" aria-label="Range start">
              ...
              <span
                className="comment-form-range-num"
                aria-label={`Start line ${range.start}`}
              >
                L{range.start}
              </span>
              <button
        ...
        <div>
          <div className="comment-form-suggest-row">
            {ai && aiSurface && aiContext && (
              <div
                className="comment-form-ai-actions"
              ...
              >
                <button
                  ...
                  onClick={() =>
                    void runAiEdit(
                      body.trim() ? "improve-comment" : "draft-comment",
                    )
                  }
                >
                  <Sparkles size={12} />{" "}
                  {body.trim() ? "Improve writing" : "Draft comment"}
                </button>
                {body.trim() && (
                  <>
                    <button
                    ...
                    <button
                      ...
                      onClick={() =>
                        onAddToAsk({
                          ...
                          selectedText:
                            aiContext.selectedText ?? lineContent ?? "",
                        })
                      }
                    >
                    ...
                    {savedReplies.map((r) => (
                      <li key={r.id}>
                        ...
                        <button
                          ...
                          onClick={() =>
                            updateSettings({
                              savedReplies: savedReplies.filter(
                                (x) => x.id !== r.id,
                              ),
                            })
                          }
